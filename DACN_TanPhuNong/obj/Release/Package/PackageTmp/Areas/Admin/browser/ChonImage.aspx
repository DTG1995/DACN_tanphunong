<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChonImage.aspx.cs" Inherits="DACN_TanPhuNong.Areas.Admin.browser.ChonImage" %>
...
<body>
	...
	<div>
        ...
        <asp:HiddenField ID="idparent"  runat="server"/>
